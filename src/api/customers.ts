...
export class CustomersAPI {
  ...
  /** Assigns tags to one or more customers by their Gameball IDs */
  async assignCustomerTags(params: { customerIds: number[]; tagIds: number[] }): Promise<unknown> {
    return this.client.request("POST", "/customers/tags", params);
  }

  /** Removes tags from one or more customers by their Gameball IDs */
  async removeCustomerTags(params: { customerIds: number[]; tagIds: number[] }): Promise<unknown> {
    return this.client.request("PUT", "/customers/tags/remove", params);
  }
}
